...
def convert(graph_def_file, output_file, output_format='TFLITE', inference_type='FLOAT', inference_input_type='FLOAT',
    ...
    # Input file flags.
    input_file_group = parser.add_mutually_exclusive_group(required=False)
    input_file_group.add_argument('-graph_def_file',
            "--graph_def_file",
            type=str,
            default=graph_def_file,
    ...
    parser.add_argument('-inference_input_type',
            "--inference_input_type",
            type=str,
            choices=["FLOAT", "QUANTIZED_UINT8"],
            default=inference_input_type,
    ...
    # parse prams
    tflite_flags = parser.parse_args()
